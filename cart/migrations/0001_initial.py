    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('final_price', models.DecimalField(decimal_places=2, default=0, max_digits=19, verbose_name='Общая цена')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='cart.customer', verbose_name='Покупатель')),
            ],
            options={
                'verbose_name': 'Заказ',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='related_customer', to='cart.Order', verbose_name='Заказы покупателя'),
        ),
        migrations.AddField(
            model_name='customer',
            name='user',
        ...
        migrations.AddField(
            model_name='customer',
            name='wishlist',
            field=models.ManyToManyField(blank=True, to='product.Product', verbose_name='Список ожидаемого'),
        ),
        migrations.CreateModel(
            name='CartProduct',
            fields=[
